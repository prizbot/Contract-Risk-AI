...
**AI Contract Compliance Engine** is an enterprise-grade contract validation and risk assessment system built using **LangGraph** and **Large Language Models (LLMs)**.

The system analyzes uploaded contracts (e.g., MSAs, NDAs, vendor agreements) and performs structured compliance validation, risk detection, and enterprise-style escalation workflows.

This project simulates real-world governance pipelines while remaining production-ready, modular, and extensible.
...
### 1️⃣ Validator Module (`validator.py`)
...
**Description:**  
Accepts `.docx` file upload and returns structured validation and escalation output.
...
Total risk score is calculated as the cumulative sum of violated rules.
...
> LLM-based high-severity detection can override numerical score when required.
...
> Escalation chain is configurable via workflow design.
